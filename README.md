...
- **Series Studio**: Plan a season, generate character cards individually, reuse finished cast through the character library, separate automatic prop references from user-specified product images, produce 18-shot episodes, and download each episode separately. See [连续剧制片说明](docs/series-studio.md).
