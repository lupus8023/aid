...
import { currentVideoDirection, VIDEO_DIRECTION_WRITING_CONTRACT, validateVideoDirection, videoDirectionEntityNames, videoDirectionSourceKey } from '@/lib/videoDirection';
...
export async function refineVideoDirections(
  ...
  options: { rewrite?: boolean; hasFirstFrame?: boolean; useReferenceImages?: boolean; isFilmEnding?: boolean } = {},
): Promise<Storyboard[]> {
