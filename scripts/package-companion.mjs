...
await cp(require('ffmpeg-static'), path.join(mediaDir, platform === 'win32' ? 'ffmpeg.exe' : 'ffmpeg'));
await cp(require('ffprobe-static').path, path.join(mediaDir, platform === 'win32' ? 'ffprobe.exe' : 'ffprobe'));
