...
export default function Step5({ storyboards, onBack }: Step5Props) {
    ...
    <div className="h-full flex flex-col">
      <div className="border-l-4 border-[var(--accent-purple)] pl-4 mb-4">
        <h2 className="text-2xl font-mono text-[var(--accent-green)] mb-2">
          <span className="text-[var(--text-secondary)]">05.</span> Video Editor
        </h2>
        <p className="text-[var(--text-secondary)] font-mono text-sm">
          Edit, trim, and arrange your video clips
        </p>
      </div>
